#!/bin/bash
sudo su -
wget  -O Dynatrace-OneAgent-Linux-1.177.216.sh "https://yaa52015.live.dynatrace.com/api/v1/deployment/installer/agent/unix/default/latest?Api-Token=Jg5IFmdeTaqz96lKWZIU_&arch=x86&flavor=default"
